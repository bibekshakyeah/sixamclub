...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTENTMEDIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTENTMEDIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTENTMEDIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTENTMEDIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTENTMEDIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTENTMEDIA actions', async () => {
      const expectedActions = [
        {
