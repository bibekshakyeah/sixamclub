...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './content.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTENT actions', async () => {
      const expectedActions = [
        {
