...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTENTTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTENTTYPE actions', async () => {
      const expectedActions = [
        {
