...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OCEANMODEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_OCEANMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OCEANMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OCEANMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OCEANMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OCEANMODEL actions', async () => {
      const expectedActions = [
        {
