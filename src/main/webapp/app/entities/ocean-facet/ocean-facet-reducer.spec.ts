...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OCEANFACET_LIST actions', async () => {
    ...
    it('dispatches FETCH_OCEANFACET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OCEANFACET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OCEANFACET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OCEANFACET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OCEANFACET actions', async () => {
      const expectedActions = [
        {
